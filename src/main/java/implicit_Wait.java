...
public class implicit_Wait
{
    public static void main(String[] args)
    {
        ...
        //It is the implicit wait ,And it's polling by every 0.5 sec for nonPresent elements in DOM
        ...
        WebElement profile=driver.findElement(By.xpath("//*[@id=\"fadein\"]/div[3]/div/div[3]/ul/li[4]/a"));
        profile.click();
